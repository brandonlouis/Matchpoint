  ...
  const generateAndDownloadTextFile = () => {
    ...
    document.body.removeChild(link);
      ...
      const generateAndDownloadExcelSche = () => {
        ...
        // Convert the binary string to a Blob
        const blob = new Blob([s3ab(binaryString)], {
                ...
                <Box display='flex' justifyContent='space-between' alignItems='center'>
                    ...
                    <Box display='flex' gap='20px'>
                        ...
                        <Button sx={{ width: '150px', height: '30px' }} startIcon={<DownloadIcon />} variant='blue' onClick={(e) => {setAnchorElScoresheet(e.currentTarget); setOpenFormatDropdownScoresheet(true);}}>Scoresheet</Button>
                            <Menu  PaperProps={{ sx: { width: '150px' } }} anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}  transformOrigin={{ vertical: 'top', horizontal: 'right' }}anchorEl={anchorElScoresheet} open={openFormatDropdownScoresheet} onClose={() => {setAnchorElScoresheet(null);
                                setOpenFormatDropdownScoresheet(false);}} disableScrollLock>
                        ...
                        <Menu PaperProps={{ sx: { width: '150px' } }} anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }} transformOrigin={{ vertical: 'top', horizontal: 'right' }} anchorEl={anchorElSchedule} open={openFormatDropdownSchedule} onClose={() => {setAnchorElSchedule(null);
                                 setOpenFormatDropdownSchedule(false);}} disableScrollLock>
