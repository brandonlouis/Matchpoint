        ...
        <Box height='100%' width='100%' minHeight='500px' padding='185px 0 150px' display='flex' justifyContent='center'>
            <Stack width='80%'>
                ...
                <Box display='flex' justifyContent='space-between' alignItems='center'>
                    ...
                    {tournamentTab === 'hosted' && (<>{user.emailVerified ? (<Button style={{ height: '45px', width: '65px' }} onClick={() => (window.location.href = '/CreateTournament')} variant='green' > <AddIcon sx={{ fontSize: '35px' }} /> </Button> 
